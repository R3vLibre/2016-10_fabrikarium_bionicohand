...
#+DATE: <2016-11-06 dim.>
#+AUTHOR: Christophe Schockaert pour Flossmanuals Francophone (CC-BY-SA 4.0)
...
licence [[https://creativecommons.org/licenses/by-sa/4.0/][Creative Commons "CC BY-SA 4.0"]], de même que toutes les images et
videos accompagnant la rédaction du manuel.

* Le projet "Bionicohand"
** Présentation
...
** Plans de la main Bionico et composants
...
Plusieurs manuels d'assemblage sont à disposition:
 ...
 - le tutoriel de [[https://www.myhumankit.org][My Human Kit]]:
   http://myhumankit.org/tutoriels/main-hackberry-exiii/

 - les manuels originaux du projet "[[http://exiii-hackberry.com][exiii HACKberry]]":

   - http://exiii-hackberry.com/dw/doku.php?id=start pour l'ensemble du
     projet

   - http://exiii-hackberry.com/dw/doku.php?id=how_to_assemble pour les
     instructions d'assemblage


La documentation ici présente fournira un mode d'emploi qui viendra
compléter les informations qui pourraient manquer dans ces guides, ou qui
viendra documenter des nouveautés ou des nouvelles fonctionnalités mises
en place.
...
utilisation différente des bornes du processeur Arduino, d'où un [[id:ddff0242-6a58-4bcd-852e-1e865a3dea7a][nouvel
adressage à prévoir entre le processeur et le circuit]].
